...
export const CreatePayment = (data) => async (dispatch) => {
  try {
    ...
    const res = await axios.post(
      "http://localhost:8080/payments/add",
      data
    );
...
export const GetSingleBed = (data) => async (dispatch) => {
  try {
    ...
    const res = await axios.post(
      "http://localhost:8080/beds/single",
      data
    );
    // console.log(res);
    return res.data;
...
export const dischargePatient = (data) => async (dispatch) => {
  try {
    ...
    const res = await axios.put(
      `http://localhost:8080/beds/discharge`,
      data
    );
    console.log(res);
    // return res.data;
